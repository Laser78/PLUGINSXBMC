...
def lista1(item):
    logger.info("pelisalacarta.torrenttv lista1")
    itemlist = []
...
def lista2(item):
    logger.info("pelisalacarta.torrenttv lista2")
    itemlist = []
...
def lista3(item):
    logger.info("pelisalacarta.torrenttv lista3")
    itemlist = []
...
def lista4(item):
    logger.info("pelisalacarta.torrenttv lista4")
    itemlist = []
...
def lista5(item):
    logger.info("pelisalacarta.torrenttv lista5")
    itemlist = []
...
def lista6(item):
    logger.info("pelisalacarta.torrenttv lista6")
    itemlist = []
...
def lista7(item):
    logger.info("pelisalacarta.torrenttv lista7")
    itemlist = []
