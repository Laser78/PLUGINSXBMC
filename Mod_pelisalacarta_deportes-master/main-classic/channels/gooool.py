...
def mainlist(item):
    logger.info("pelisalacarta.channels.gooool mainlist")
    itemlist = []
...
def agenda(item):
    logger.info("pelisalacarta.channels.gooool agenda")
    itemlist = []
...
def futbol(item):
    logger.info("pelisalacarta.channels.gooool futbol")
    itemlist = []
...
def deportes(item):
    logger.info("pelisalacarta.channels.gooool deportes")
    itemlist = []
...
def videos(item):
    logger.info("pelisalacarta.channels.gooool videos")
    itemlist = []
...
def findlives(item):
    logger.info("pelisalacarta.channels.gooool findlives")
    itemlist = []
...
def play(item):
    logger.info("pelisalacarta.channels.gooool play")
    itemlist = []
