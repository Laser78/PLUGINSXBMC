...
def mainlist(item):
    logger.info("pelisalacarta.channels.agendaglobal mainlist")
    itemlist = []
...
def configuracion(item):
    logger.info("pelisalacarta.channels.agendaglobal configuracion")
    controls = []
...
def filtro(item):
    logger.info("pelisalacarta.channels.agendaglobal filtros")
    text = ""
...
def agenda(item):
    logger.info("pelisalacarta.channels.agendaglobal agenda")
    itemlist = []
