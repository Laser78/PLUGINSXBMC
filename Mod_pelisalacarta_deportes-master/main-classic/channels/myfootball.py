...
def mainlist(item):
    logger.info("pelisalacarta.channels.myfootball mainlist")
    itemlist = []
...
def agenda(item):
    logger.info("pelisalacarta.channels.myfootball agenda")
    itemlist = []
...
def findlives(item):
    logger.info("pelisalacarta.channels.myfootball findlives")
    itemlist = []
...
def futbol(item):
    logger.info("pelisalacarta.channels.myfootball futbol")
    itemlist = []
...
def cat(item):
    logger.info("pelisalacarta.channels.myfootball cat")
    itemlist = []
...
def play(item):
    logger.info("pelisalacarta.channels.myfootball play")
    itemlist = []
