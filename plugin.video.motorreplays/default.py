...
messagetext     ='http://aleightyrepo.comli.com/Addons/MotorReplays/info.xml'+'?%d=%s' % (random.randint(1, 10000), random.randint(1, 10000))
...
def GetMenu():
        ...
        addDir('[B][COLOR white]Search[/COLOR][/B] [B][COLOR yellow]Motor Replays[/COLOR][/B]',url,5,searchicon,fanarts)
